...
const Controls = () => {
  return (
    <div className="select-none flex items-center gap-2.5 p-2 my-1">
      <div className="flex flex-col gap-1 items-center">
        ...
        <p className="text-[0.675rem] font-medium text-foreground/50">Start</p>
      </div>
      <div className="flex flex-col gap-1 items-center">
        ...
        <p className="text-[0.675rem] font-medium text-foreground/50">Mic</p>
      </div>
      <div className="flex flex-col gap-1 items-center">
        <button className="flex items-center justify-center border border-call-border p-3 rounded-xl bg-call-primary text-lg font-medium cursor-pointer hover:bg-primary-hover transition-all duration-200">
          <FiVideo />
        </button>
        <p className="text-[0.675rem] font-medium text-foreground/50">Cam</p>
      </div>
      <div className="flex flex-col gap-1 items-center">
        <button className="flex items-center justify-center border border-call-border p-3 rounded-xl bg-call-primary text-lg font-medium cursor-pointer hover:bg-primary-hover transition-all duration-200">
          <RxSpeakerLoud />
        </button>
        <p className="text-[0.675rem] font-medium text-foreground/50">Speaker</p>
      </div>
      <div className="flex flex-col gap-1 items-center">
        <button className="flex items-center justify-center border border-call-border p-3 rounded-xl bg-call-primary text-lg font-medium cursor-pointer hover:bg-primary-hover transition-all duration-200">
          <LuScreenShare />
        </button>
        <p className="text-[0.675rem] font-medium text-foreground/50">Share</p>
      </div>
      ...
      <div className="flex flex-col gap-1 items-center">
        ...
        <p className="text-[0.675rem] font-medium text-foreground/50">Leave</p>
      </div>
    </div>
  )
}
